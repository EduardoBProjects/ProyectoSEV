...
<body>
  ...
  <h1> Reservación hecha exitosamente </h1>
  <p> Gracias por confiar en PI </p> 
</div>
<div class="container">
    <br>
  <h2 class="text-center"> Código QR</h2>
  <img src="QR.png" class="mx-auto d-block" alt="Cinque Terre" width="400" height="400">
  <p> Recuerde que después de reservar su lugar tendrá aproximadamente 30min para arribar al lugar
  establecido de lo contrario se perderá y tendrá que generar uno nuevo.</p>
</div>
<div class="container">
    <br>
